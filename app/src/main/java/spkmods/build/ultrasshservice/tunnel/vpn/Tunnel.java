...
package spkmods.build.ultrasshservice.tunnel.vpn;
...
public class Tunnel
{
	...
	public synchronized boolean startRouting(TunnelVpnSettings settings) throws java.lang.Exception
	{
		return startVpn(settings.mDnsForward, settings.mDnsResolver, settings.mExcludeIps,
			settings.mEnableFilterApps, settings.mFilterBypassMode, settings.mFilterApps, settings.mTetheringSubnet, settings.mLogBypass);
	}
	...
	private static final String DNS_RESOLVER_IP = "1.1.1.1";
	...
	private boolean startVpn(boolean forwardDns, String[] dnsResolver, String[] excludeIps,
							 boolean enabledFilter, boolean filterBypassMode, String[] filterApps, boolean enableTethering, boolean isBypass) throws java.lang.Exception
	{
...
/*
        ...
        mTun2Socks.setOnTun2SocksListener(new Tun2Socks.OnTun2SocksListener(){
                ...
                public void onStart()
                {
                    ...
                    if (udpResolver != null) {
                        mHostService.onDiagnosticMessage("UDP Forwarding Activated");
                    }
                }
                @Override
                public void onStop()
