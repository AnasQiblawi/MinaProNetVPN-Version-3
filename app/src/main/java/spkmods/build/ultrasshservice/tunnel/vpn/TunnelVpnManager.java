...
public class TunnelVpnManager implements Tunnel.HostService
{
	...
	{
		boolean m_dnsForward = new Settings(getContext()).getVpnDnsForward();
		if (m_dnsForward) {
			SkStatus.logInfo("<b>Forward DNS Enabled</b>");
		}
		SkStatus.logError("<strong><font color='green'>MinaProNet VPN Connected</font></strong>");
	}
	...
	{
		SkStatus.logError("<strong><font color='green'>Powered by: MinaProNet</font></strong>");
		startTunnel();
	}
}
