package spkmods.build.ultrasshservice;
...
import spkmods.build.ultrasshservice.aidl.IUltraSSHServiceInternal;
...
import spkmods.build.ultrasshservice.tunnel.DNSTunnelThread;
import spkmods.build.ultrasshservice.tunnel.TunnelManagerThread;
import spkmods.build.ultrasshservice.tunnel.TunnelUtils;
import spkmods.build.ultrasshservice.util.DummyActivity;
...
public class SocksHttpService extends Service implements SkStatus.StateListener {
    ...
    public static final String START_SERVICE = "spkmods.build.ultrasshservice:startTunnel";
    ...
    public void onCreate() {
        ...
        wakeLock =
                ((PowerManager) getSystemService(Context.POWER_SERVICE))
                        .newWakeLock(1, "MinaProNet::WakelockService");
    ...
    public synchronized void startTunnel() {
        SkStatus.updateStateString(
                SkStatus.SSH_INICIANDO, getString(R.string.starting_service_ssh));
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK| PendingIntent.FLAG_IMMUTABLE);
...
/*
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
        ...
        PendingIntent reconnectPendingIntent =
                PendingIntent.getBroadcast(
                        this, 0, reconnectVPN, PendingIntent.FLAG_CANCEL_CURRENT |PendingIntent.FLAG_IMMUTABLE );
        ...
        PendingIntent disconnectPendingIntent =
                PendingIntent.getBroadcast(
                        this, 0, disconnectVPN, PendingIntent.FLAG_CANCEL_CURRENT |PendingIntent.FLAG_IMMUTABLE);
    ...
    public static final String
            TUNNEL_SSH_RESTART_SERVICE =
                    SocksHttpService.class.getName() + "::restartservicebroadcast",
